  ...
  return (
      <div className="article-container">
        ...
        <div className="article-wrapper">
          <Grid className="article-top-section" container columnSpacing={{lg:6, xl: 6}} >
            <Grid item lg={4} xl={4}>
          ...
          <Grid className="article-middle-section" container columnSpacing={{lg:6, xl:6}} >
            <Grid item lg={4} xl={4}>
            ...
            <Grid container item lg={8} xl={8}  rowSpacing={{lg:4, xl:4}}>
              ...
              <Grid container item lg={12} xl={12} columnSpacing={{lg:6, xl:6}}>
                <Grid item lg={6} xl={6}>
                  <div className="article-middle-section-paragraph-2" style={{borderLeft: "solid 1px", borderColor: "#c4c4c4", paddingLeft: "20px" }}>
                    <p>
                      {data[0].paragraph_4}
                    </p>
                  </div>
          ...
          <Grid className="article-bottom-section" container columnSpacing={{lg:4, xl:4}} justifyContent="center" alignItems="center" >
