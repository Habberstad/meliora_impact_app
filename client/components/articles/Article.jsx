  ...
  return (
    <div className="article-container">
      <div>
        ...
        <img src={FishHeader} alt="header-img" className="article-header-img" />
      </div>
            ...
            <Grid item xl={5}>
              <div className="middle-section-item-2">
                <p>
                  ...
                  sit amet, sed ea solum movet scriptorem, eos dolore evertitur
                  ei, ferri omnium sea at. Harum accusam suscipiantur in pri,
                  constituto appellantur consequuntur ei his. Pro at mollis
                  aliquid civibus. Dicam ornatus ex duo, duo te aeque bonorum.
                </p>
              </div>
            </Grid>
            <Grid item xl={5}>
