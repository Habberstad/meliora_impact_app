                ...
                <Grid item md={12} lg={6} xl={6}>
                    <div className="container-big">
                        <div className={"container-content-big"}>
                            ...
                            <Link href={"/articles/article?id=" + props.data[0]._id}>
                    ...
                    <Grid item md={12} lg={12} xl={12}>
                        <div className="container-medium">
                            <div className={"container-content-medium"}>
                                ...
                                <Link href={"/articles/article?id=" + props.data[1]._id}>
                        ...
                        <Grid item md={6} lg={6} xl={6}>
                            <div className="container-small">
                                <div className={"container-content-small"}>
                                    ...
                                    <Link href={"/articles/article?id=" + props.data[2]._id}>
                        ...
                        <Grid item md={6} lg={6} xl={6}>
                            <div className="container-small">
                                <div className={"container-content-small"}>
                                    ...
                                    <Link href={"/articles/article?id=" + props.data[3]._id}>
